    ...
    -- ========================================================================
    {
        ...
        opts = {
            ...
            presets = {
                ...
                command_palette = false,      -- Disable to show cmdline immediately
            ...
            -- Views configuration - position notifications at top-right
            views = {
                notify = {
                    position = {
                        row = 0,      -- Top of screen (0 = top, 100% = bottom)
                        col = "100%", -- Right side
                    },
                },
                cmdline_popup = {
                    position = {
                        row = "30%", -- 30% from top (70% up on screen)
