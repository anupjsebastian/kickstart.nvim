...
-- ========================================================================
-- WEB DEVELOPMENT - Browser Preview
-- ========================================================================
...
local function open_in_browser(browser)
  ...
  -- Check if current file is a web file
  if filetype == 'html' or filetype == 'svelte' or filetype == 'javascript' or filetype == 'typescript' then
    ...
    vim.notify('Browser preview only works for HTML/Svelte/JS/TS files', vim.log.levels.WARN)
  end
end
...
end, { desc = 'Open in Chrome' })

-- Open in Safari
vim.keymap.set('n', '<leader>os', function()
  open_in_browser('Safari')
end, { desc = 'Open in Safari' })
...
-- Start live-server in terminal split (requires live-server: npm install -g live-server)
vim.keymap.set('n', '<leader>ol', function()
  -- Open a terminal split and run live-server
  vim.cmd('split | terminal live-server')
  vim.notify('Live server started. Press Ctrl+C to stop.', vim.log.levels.INFO)
end, { desc = 'Start live-server in split' })
